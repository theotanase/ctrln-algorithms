...
function addNumberToTree(value: number, tree: BSTNode) {
    if (value <= tree.value) {
        if (tree.left == null) {
...
function printAscendingOrder(tree: BSTNode | null) {
    if (tree == null) {
        return;
    }
...
function isNumberInTree(needle: number, tree: BSTNode | null) {
    if (tree == null) {
        return false;
    }
